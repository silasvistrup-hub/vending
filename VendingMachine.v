...
`endif // RANDOMIZE_REG_INIT
  ...
  reg [7:0] Value; // @[src/main/scala/VendingMachine.scala 18:22]
  wire  Full2 = Value > 8'h61; // @[src/main/scala/VendingMachine.scala 19:21]
  wire  Full5 = Value > 8'h5e; // @[src/main/scala/VendingMachine.scala 20:21]
  wire [7:0] _GEN_12 = {{3'd0}, io_price}; // @[src/main/scala/VendingMachine.scala 21:22]
  wire  enough = Value >= _GEN_12; // @[src/main/scala/VendingMachine.scala 21:22]
  reg [9:0] count_to_4; // @[src/main/scala/VendingMachine.scala 22:27]
  reg  coin2_previous; // @[src/main/scala/VendingMachine.scala 25:31]
  reg  coin5_previous; // @[src/main/scala/VendingMachine.scala 26:31]
  reg  buy_previous; // @[src/main/scala/VendingMachine.scala 27:31]
  wire  coin2_change = io_coin2 & ~coin2_previous; // @[src/main/scala/VendingMachine.scala 29:31]
  wire  coin5_change = io_coin5 & ~coin5_previous; // @[src/main/scala/VendingMachine.scala 30:31]
  wire  buy_change = io_buy & ~buy_previous; // @[src/main/scala/VendingMachine.scala 31:29]
  wire [7:0] _Value_T_1 = Value + 8'h2; // @[src/main/scala/VendingMachine.scala 39:20]
  wire [7:0] _Value_T_3 = Value + 8'h5; // @[src/main/scala/VendingMachine.scala 41:20]
  wire  _T_4 = buy_change & enough; // @[src/main/scala/VendingMachine.scala 42:25]
  wire [7:0] _Value_T_5 = Value - _GEN_12; // @[src/main/scala/VendingMachine.scala 43:20]
  reg  ringalarm; // @[src/main/scala/VendingMachine.scala 46:26]
  wire  _GEN_3 = buy_change & ~enough | ringalarm; // @[src/main/scala/VendingMachine.scala 47:32 48:14 46:26]
  reg  dispense; // @[src/main/scala/VendingMachine.scala 51:25]
  wire  _GEN_6 = count_to_4 == 10'h0 ? 1'h0 : dispense; // @[src/main/scala/VendingMachine.scala 52:28 54:14 51:25]
  wire  _GEN_7 = _T_4 | _GEN_6; // @[src/main/scala/VendingMachine.scala 58:31 59:13]
  reg [31:0] tick_tickCnt; // @[src/main/scala/VendingMachine.scala 64:26]
  wire  tick = tick_tickCnt == 32'h1869f; // @[src/main/scala/VendingMachine.scala 67:18]
  wire [31:0] _tick_tickCnt_T_1 = tick_tickCnt + 32'h1; // @[src/main/scala/VendingMachine.scala 71:26]
  wire [9:0] _count_to_4_T_1 = count_to_4 + 10'h1; // @[src/main/scala/VendingMachine.scala 80:30]
  ...
  assign io_releaseCan = dispense; // @[src/main/scala/VendingMachine.scala 86:17]
  assign io_alarm = ringalarm; // @[src/main/scala/VendingMachine.scala 85:12]
  assign io_seg = DisplayMultiplexer_io_seg; // @[src/main/scala/VendingMachine.scala 89:10]
  assign io_an = DisplayMultiplexer_io_an; // @[src/main/scala/VendingMachine.scala 90:9]
  assign DisplayMultiplexer_clock = clock;
  assign DisplayMultiplexer_reset = reset;
  assign DisplayMultiplexer_io_sum = Value; // @[src/main/scala/VendingMachine.scala 87:28]
  assign DisplayMultiplexer_io_price = io_price; // @[src/main/scala/VendingMachine.scala 88:31]
  always @(posedge clock) begin
    if (reset) begin // @[src/main/scala/VendingMachine.scala 18:22]
      Value <= 8'h0; // @[src/main/scala/VendingMachine.scala 18:22]
    end else if (coin2_change & ~Full2) begin // @[src/main/scala/VendingMachine.scala 38:32]
      Value <= _Value_T_1; // @[src/main/scala/VendingMachine.scala 39:11]
    end else if (coin5_change & ~Full5) begin // @[src/main/scala/VendingMachine.scala 40:38]
      Value <= _Value_T_3; // @[src/main/scala/VendingMachine.scala 41:11]
    end else if (buy_change & enough) begin // @[src/main/scala/VendingMachine.scala 42:36]
      Value <= _Value_T_5; // @[src/main/scala/VendingMachine.scala 43:11]
    end
    if (reset) begin // @[src/main/scala/VendingMachine.scala 22:27]
      count_to_4 <= 10'h0; // @[src/main/scala/VendingMachine.scala 22:27]
    end else if (tick) begin // @[src/main/scala/VendingMachine.scala 79:14]
      count_to_4 <= _count_to_4_T_1; // @[src/main/scala/VendingMachine.scala 80:16]
    end else if (_T_4) begin // @[src/main/scala/VendingMachine.scala 58:31]
      count_to_4 <= 10'h1; // @[src/main/scala/VendingMachine.scala 60:14]
    end else if (buy_change & ~enough) begin // @[src/main/scala/VendingMachine.scala 47:32]
      count_to_4 <= 10'h1; // @[src/main/scala/VendingMachine.scala 49:16]
    end
    coin2_previous <= io_coin2; // @[src/main/scala/VendingMachine.scala 25:31]
    coin5_previous <= io_coin5; // @[src/main/scala/VendingMachine.scala 26:31]
    buy_previous <= io_buy; // @[src/main/scala/VendingMachine.scala 27:31]
    if (reset) begin // @[src/main/scala/VendingMachine.scala 46:26]
      ringalarm <= 1'h0; // @[src/main/scala/VendingMachine.scala 46:26]
    end else if (count_to_4 == 10'h0) begin // @[src/main/scala/VendingMachine.scala 52:28]
      ringalarm <= 1'h0; // @[src/main/scala/VendingMachine.scala 53:15]
    end else begin
      ringalarm <= _GEN_3;
    end
    if (reset) begin // @[src/main/scala/VendingMachine.scala 51:25]
      dispense <= 1'h0; // @[src/main/scala/VendingMachine.scala 51:25]
    end else begin
      dispense <= _GEN_7;
    end
    if (reset) begin // @[src/main/scala/VendingMachine.scala 64:26]
      tick_tickCnt <= 32'h0; // @[src/main/scala/VendingMachine.scala 64:26]
    end else if (tick) begin // @[src/main/scala/VendingMachine.scala 67:35]
      tick_tickCnt <= 32'h0; // @[src/main/scala/VendingMachine.scala 68:15]
    end else begin
      tick_tickCnt <= _tick_tickCnt_T_1; // @[src/main/scala/VendingMachine.scala 71:15]
    end
  end
// Register and memory initialization
`ifdef RANDOMIZE_GARBAGE_ASSIGN
