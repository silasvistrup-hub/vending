...
`endif // RANDOMIZE_REG_INIT
  ...
  wire  _GEN_6 = io_full | FullSequence; // @[\\src\\main\\scala\\DisplayMultiplexer1.scala 35:17 36:18 15:29]
  reg [3:0] Number2Full; // @[\\src\\main\\scala\\DisplayMultiplexer1.scala 44:28]
  reg [3:0] Number1Full; // @[\\src\\main\\scala\\DisplayMultiplexer1.scala 45:28]
  reg [3:0] Number4Full; // @[\\src\\main\\scala\\DisplayMultiplexer1.scala 46:28]
  reg [3:0] Number3Full; // @[\\src\\main\\scala\\DisplayMultiplexer1.scala 47:28]
  wire [3:0] _GEN_9 = 4'h9 == CountTo16 ? 4'hd : Number2Full; // @[\\src\\main\\scala\\DisplayMultiplexer1.scala 114:19 49:21 44:28]
  wire [3:0] _GEN_10 = 4'h9 == CountTo16 ? 4'hd : Number1Full; // @[\\src\\main\\scala\\DisplayMultiplexer1.scala 115:19 49:21 45:28]
  wire [3:0] _GEN_11 = 4'h9 == CountTo16 ? 4'hd : Number4Full; // @[\\src\\main\\scala\\DisplayMultiplexer1.scala 116:19 49:21 46:28]
  wire [3:0] _GEN_12 = 4'h9 == CountTo16 ? 4'hd : Number3Full; // @[\\src\\main\\scala\\DisplayMultiplexer1.scala 117:19 49:21 47:28]
  wire [3:0] _GEN_13 = 4'h8 == CountTo16 ? 4'hd : _GEN_9; // @[\\src\\main\\scala\\DisplayMultiplexer1.scala 107:19 49:21]
  wire [3:0] _GEN_14 = 4'h8 == CountTo16 ? 4'hd : _GEN_10; // @[\\src\\main\\scala\\DisplayMultiplexer1.scala 108:19 49:21]
  wire [3:0] _GEN_15 = 4'h8 == CountTo16 ? 4'hd : _GEN_11; // @[\\src\\main\\scala\\DisplayMultiplexer1.scala 109:19 49:21]
  wire [3:0] _GEN_16 = 4'h8 == CountTo16 ? 4'hd : _GEN_12; // @[\\src\\main\\scala\\DisplayMultiplexer1.scala 110:19 49:21]
  wire [3:0] _GEN_17 = 4'h7 == CountTo16 ? 4'hd : _GEN_13; // @[\\src\\main\\scala\\DisplayMultiplexer1.scala 100:19 49:21]
  wire [3:0] _GEN_18 = 4'h7 == CountTo16 ? 4'hd : _GEN_14; // @[\\src\\main\\scala\\DisplayMultiplexer1.scala 101:19 49:21]
  wire [3:0] _GEN_19 = 4'h7 == CountTo16 ? 4'hd : _GEN_15; // @[\\src\\main\\scala\\DisplayMultiplexer1.scala 102:19 49:21]
  wire [3:0] _GEN_20 = 4'h7 == CountTo16 ? 4'ha : _GEN_16; // @[\\src\\main\\scala\\DisplayMultiplexer1.scala 103:19 49:21]
  wire [3:0] _GEN_21 = 4'h6 == CountTo16 ? 4'hd : _GEN_17; // @[\\src\\main\\scala\\DisplayMultiplexer1.scala 49:21 93:19]
  wire [3:0] _GEN_22 = 4'h6 == CountTo16 ? 4'hd : _GEN_18; // @[\\src\\main\\scala\\DisplayMultiplexer1.scala 49:21 94:19]
  wire [3:0] _GEN_23 = 4'h6 == CountTo16 ? 4'ha : _GEN_19; // @[\\src\\main\\scala\\DisplayMultiplexer1.scala 49:21 95:19]
  wire [3:0] _GEN_24 = 4'h6 == CountTo16 ? 4'hb : _GEN_20; // @[\\src\\main\\scala\\DisplayMultiplexer1.scala 49:21 96:19]
  wire [3:0] _GEN_25 = 4'h5 == CountTo16 ? 4'hd : _GEN_21; // @[\\src\\main\\scala\\DisplayMultiplexer1.scala 49:21 86:19]
  wire [3:0] _GEN_26 = 4'h5 == CountTo16 ? 4'ha : _GEN_22; // @[\\src\\main\\scala\\DisplayMultiplexer1.scala 49:21 87:19]
  wire [3:0] _GEN_27 = 4'h5 == CountTo16 ? 4'hb : _GEN_23; // @[\\src\\main\\scala\\DisplayMultiplexer1.scala 49:21 88:19]
  wire [3:0] _GEN_28 = 4'h5 == CountTo16 ? 4'hc : _GEN_24; // @[\\src\\main\\scala\\DisplayMultiplexer1.scala 49:21 89:19]
  wire [3:0] _GEN_29 = 4'h4 == CountTo16 ? 4'ha : _GEN_25; // @[\\src\\main\\scala\\DisplayMultiplexer1.scala 49:21 79:19]
  wire [3:0] _GEN_30 = 4'h4 == CountTo16 ? 4'hb : _GEN_26; // @[\\src\\main\\scala\\DisplayMultiplexer1.scala 49:21 80:19]
  wire [3:0] _GEN_31 = 4'h4 == CountTo16 ? 4'hc : _GEN_27; // @[\\src\\main\\scala\\DisplayMultiplexer1.scala 49:21 81:19]
  wire [3:0] _GEN_32 = 4'h4 == CountTo16 ? 4'hc : _GEN_28; // @[\\src\\main\\scala\\DisplayMultiplexer1.scala 49:21 82:19]
  wire [3:0] _GEN_33 = 4'h3 == CountTo16 ? 4'hb : _GEN_29; // @[\\src\\main\\scala\\DisplayMultiplexer1.scala 49:21 72:19]
  wire [3:0] _GEN_34 = 4'h3 == CountTo16 ? 4'hc : _GEN_30; // @[\\src\\main\\scala\\DisplayMultiplexer1.scala 49:21 73:19]
  wire [3:0] _GEN_35 = 4'h3 == CountTo16 ? 4'hc : _GEN_31; // @[\\src\\main\\scala\\DisplayMultiplexer1.scala 49:21 74:19]
  wire [3:0] _GEN_36 = 4'h3 == CountTo16 ? 4'hd : _GEN_32; // @[\\src\\main\\scala\\DisplayMultiplexer1.scala 49:21 75:19]
  ...
  wire [7:0] _GEN_49 = ~FullSequence ? _number2_T : {{4'd0}, Number2Full}; // @[\\src\\main\\scala\\DisplayMultiplexer1.scala 121:23 122:13 127:13]
  wire [3:0] number1 = ~FullSequence ? _GEN_1[3:0] : Number1Full; // @[\\src\\main\\scala\\DisplayMultiplexer1.scala 121:23 123:13 128:13]
  wire [4:0] _GEN_51 = ~FullSequence ? _number4_T : {{1'd0}, Number4Full}; // @[\\src\\main\\scala\\DisplayMultiplexer1.scala 121:23 124:13 129:13]
  wire [3:0] number3 = ~FullSequence ? _GEN_3[3:0] : Number3Full; // @[\\src\\main\\scala\\DisplayMultiplexer1.scala 121:23 125:13 130:13]
  wire [3:0] number2 = _GEN_49[3:0]; // @[\\src\\main\\scala\\DisplayMultiplexer1.scala 41:28]
  wire [3:0] _GEN_53 = 2'h3 == CountTo4 ? number2 : 4'h0; // @[\\src\\main\\scala\\DisplayMultiplexer1.scala 133:17 135:20 140:32]
  wire [3:0] _GEN_54 = 2'h2 == CountTo4 ? number1 : _GEN_53; // @[\\src\\main\\scala\\DisplayMultiplexer1.scala 135:20 139:32]
  wire [3:0] number4 = _GEN_51[3:0]; // @[\\src\\main\\scala\\DisplayMultiplexer1.scala 43:28]
  wire [3:0] _GEN_55 = 2'h1 == CountTo4 ? number4 : _GEN_54; // @[\\src\\main\\scala\\DisplayMultiplexer1.scala 135:20 138:32]
  wire [3:0] _io_an_T = 4'h1 << CountTo4; // @[\\src\\main\\scala\\DisplayMultiplexer1.scala 142:18]
  ...
  assign decoder_io_in = 2'h0 == CountTo4 ? number3 : _GEN_55; // @[\\src\\main\\scala\\DisplayMultiplexer1.scala 135:20 137:32]
  always @(posedge clock) begin
    ...
    end else if (CountTo16 == 4'ha) begin // @[\\src\\main\\scala\\DisplayMultiplexer1.scala 38:25]
      FullSequence <= 1'h0; // @[\\src\\main\\scala\\DisplayMultiplexer1.scala 38:38]
    end else begin
      FullSequence <= _GEN_6;
    end
    if (reset) begin // @[\\src\\main\\scala\\DisplayMultiplexer1.scala 16:26]
      ...
      CountTo16 <= 4'h0; // @[\\src\\main\\scala\\DisplayMultiplexer1.scala 37:14]
    ...
    if (reset) begin // @[\\src\\main\\scala\\DisplayMultiplexer1.scala 44:28]
      Number2Full <= 4'hd; // @[\\src\\main\\scala\\DisplayMultiplexer1.scala 44:28]
    end else if (4'h0 == CountTo16) begin // @[\\src\\main\\scala\\DisplayMultiplexer1.scala 49:21]
      Number2Full <= 4'hd; // @[\\src\\main\\scala\\DisplayMultiplexer1.scala 51:19]
    end else if (4'h1 == CountTo16) begin // @[\\src\\main\\scala\\DisplayMultiplexer1.scala 49:21]
      Number2Full <= 4'hc; // @[\\src\\main\\scala\\DisplayMultiplexer1.scala 58:19]
    end else if (4'h2 == CountTo16) begin // @[\\src\\main\\scala\\DisplayMultiplexer1.scala 49:21]
      Number2Full <= 4'hc; // @[\\src\\main\\scala\\DisplayMultiplexer1.scala 65:19]
    end else begin
      Number2Full <= _GEN_33;
    end
    if (reset) begin // @[\\src\\main\\scala\\DisplayMultiplexer1.scala 45:28]
      Number1Full <= 4'hd; // @[\\src\\main\\scala\\DisplayMultiplexer1.scala 45:28]
    end else if (4'h0 == CountTo16) begin // @[\\src\\main\\scala\\DisplayMultiplexer1.scala 49:21]
      Number1Full <= 4'hd; // @[\\src\\main\\scala\\DisplayMultiplexer1.scala 52:19]
    end else if (4'h1 == CountTo16) begin // @[\\src\\main\\scala\\DisplayMultiplexer1.scala 49:21]
      Number1Full <= 4'hd; // @[\\src\\main\\scala\\DisplayMultiplexer1.scala 59:19]
    end else if (4'h2 == CountTo16) begin // @[\\src\\main\\scala\\DisplayMultiplexer1.scala 49:21]
      Number1Full <= 4'hc; // @[\\src\\main\\scala\\DisplayMultiplexer1.scala 66:19]
    end else begin
      Number1Full <= _GEN_34;
    end
    if (reset) begin // @[\\src\\main\\scala\\DisplayMultiplexer1.scala 46:28]
      Number4Full <= 4'hd; // @[\\src\\main\\scala\\DisplayMultiplexer1.scala 46:28]
    end else if (4'h0 == CountTo16) begin // @[\\src\\main\\scala\\DisplayMultiplexer1.scala 49:21]
      Number4Full <= 4'hd; // @[\\src\\main\\scala\\DisplayMultiplexer1.scala 53:19]
    end else if (4'h1 == CountTo16) begin // @[\\src\\main\\scala\\DisplayMultiplexer1.scala 49:21]
      Number4Full <= 4'hd; // @[\\src\\main\\scala\\DisplayMultiplexer1.scala 60:19]
    end else if (4'h2 == CountTo16) begin // @[\\src\\main\\scala\\DisplayMultiplexer1.scala 49:21]
      Number4Full <= 4'hd; // @[\\src\\main\\scala\\DisplayMultiplexer1.scala 67:19]
    end else begin
      Number4Full <= _GEN_35;
    end
    if (reset) begin // @[\\src\\main\\scala\\DisplayMultiplexer1.scala 47:28]
      Number3Full <= 4'hd; // @[\\src\\main\\scala\\DisplayMultiplexer1.scala 47:28]
    end else if (4'h0 == CountTo16) begin // @[\\src\\main\\scala\\DisplayMultiplexer1.scala 49:21]
      Number3Full <= 4'hd; // @[\\src\\main\\scala\\DisplayMultiplexer1.scala 54:19]
    end else if (4'h1 == CountTo16) begin // @[\\src\\main\\scala\\DisplayMultiplexer1.scala 49:21]
      Number3Full <= 4'hd; // @[\\src\\main\\scala\\DisplayMultiplexer1.scala 61:19]
    end else if (4'h2 == CountTo16) begin // @[\\src\\main\\scala\\DisplayMultiplexer1.scala 49:21]
      Number3Full <= 4'hd; // @[\\src\\main\\scala\\DisplayMultiplexer1.scala 68:19]
    end else begin
      Number3Full <= _GEN_36;
    end
  end
