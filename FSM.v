...
module FSM(
  input        clock,
  input        reset,
  input  [4:0] io_price, // @[\\src\\main\\scala\\FSM.scala 6:14]
  input        io_coin2, // @[\\src\\main\\scala\\FSM.scala 6:14]
  input        io_coin5, // @[\\src\\main\\scala\\FSM.scala 6:14]
  input        io_buy, // @[\\src\\main\\scala\\FSM.scala 6:14]
  output       io_releaseCan, // @[\\src\\main\\scala\\FSM.scala 6:14]
  output       io_alarm, // @[\\src\\main\\scala\\FSM.scala 6:14]
  output [6:0] io_seg, // @[\\src\\main\\scala\\FSM.scala 6:14]
  output [3:0] io_an, // @[\\src\\main\\scala\\FSM.scala 6:14]
  output       io_tx // @[\\src\\main\\scala\\FSM.scala 6:14]
);
`ifdef RANDOMIZE_REG_INIT
  reg [31:0] _RAND_0;
  reg [31:0] _RAND_1;
  ...
  reg [31:0] _RAND_3;
`endif // RANDOMIZE_REG_INIT
  wire  extender_clock; // @[\\src\\main\\scala\\FSM.scala 26:24]
  wire  extender_reset; // @[\\src\\main\\scala\\FSM.scala 26:24]
  wire  extender_io_Ringalarm; // @[\\src\\main\\scala\\FSM.scala 26:24]
  wire  extender_io_releasing; // @[\\src\\main\\scala\\FSM.scala 26:24]
  wire  extender_io_alarm; // @[\\src\\main\\scala\\FSM.scala 26:24]
  wire  extender_io_releaseCan; // @[\\src\\main\\scala\\FSM.scala 26:24]
  wire  DisplayMultiplexer_clock; // @[\\src\\main\\scala\\FSM.scala 27:34]
  wire  DisplayMultiplexer_reset; // @[\\src\\main\\scala\\FSM.scala 27:34]
  wire [7:0] DisplayMultiplexer_io_sum; // @[\\src\\main\\scala\\FSM.scala 27:34]
  wire [4:0] DisplayMultiplexer_io_price; // @[\\src\\main\\scala\\FSM.scala 27:34]
  wire [6:0] DisplayMultiplexer_io_seg; // @[\\src\\main\\scala\\FSM.scala 27:34]
  wire [3:0] DisplayMultiplexer_io_an; // @[\\src\\main\\scala\\FSM.scala 27:34]
  wire  DisplayMultiplexer_io_full; // @[\\src\\main\\scala\\FSM.scala 27:34]
  wire  Datapath_clock; // @[\\src\\main\\scala\\FSM.scala 28:24]
  wire  Datapath_reset; // @[\\src\\main\\scala\\FSM.scala 28:24]
  wire [4:0] Datapath_io_price; // @[\\src\\main\\scala\\FSM.scala 28:24]
  wire [2:0] Datapath_io_FSMstate; // @[\\src\\main\\scala\\FSM.scala 28:24]
  wire  Datapath_io_Full2; // @[\\src\\main\\scala\\FSM.scala 28:24]
  wire  Datapath_io_Full5; // @[\\src\\main\\scala\\FSM.scala 28:24]
  wire  Datapath_io_enough; // @[\\src\\main\\scala\\FSM.scala 28:24]
  wire [6:0] Datapath_io_money; // @[\\src\\main\\scala\\FSM.scala 28:24]
  reg [2:0] stateReg; // @[\\src\\main\\scala\\FSM.scala 23:25]
  ...
  wire  coin2Trigger = io_coin2 & ~prevCoin2; // @[\\src\\main\\scala\\FSM.scala 35:31]
  wire  coin5Trigger = io_coin5 & ~prevCoin5; // @[\\src\\main\\scala\\FSM.scala 36:31]
  wire  buyTrigger = io_buy & ~prevBuy; // @[\\src\\main\\scala\\FSM.scala 37:27]
  wire [2:0] _GEN_0 = coin5Trigger & Datapath_io_Full5 ? 3'h5 : 3'h0; // @[\\src\\main\\scala\\FSM.scala 24:12 55:41 56:18]
  wire [2:0] _GEN_1 = coin2Trigger & Datapath_io_Full2 ? 3'h5 : _GEN_0; // @[\\src\\main\\scala\\FSM.scala 53:41 54:18]
  wire [2:0] _GEN_2 = buyTrigger & Datapath_io_enough ? 3'h4 : _GEN_1; // @[\\src\\main\\scala\\FSM.scala 51:40 52:18]
  wire [2:0] _GEN_3 = buyTrigger & ~Datapath_io_enough ? 3'h3 : _GEN_2; // @[\\src\\main\\scala\\FSM.scala 49:41 50:18]
  extender extender ( // @[\\src\\main\\scala\\FSM.scala 26:24]
  ...
  DisplayMultiplexer DisplayMultiplexer ( // @[\\src\\main\\scala\\FSM.scala 27:34]
  ...
  Datapath Datapath ( // @[\\src\\main\\scala\\FSM.scala 28:24]
  ...
  assign io_releaseCan = extender_io_releaseCan; // @[\\src\\main\\scala\\FSM.scala 69:17]
  assign io_alarm = extender_io_alarm; // @[\\src\\main\\scala\\FSM.scala 68:12]
  assign io_seg = DisplayMultiplexer_io_seg; // @[\\src\\main\\scala\\FSM.scala 70:10]
  assign io_an = DisplayMultiplexer_io_an; // @[\\src\\main\\scala\\FSM.scala 71:9]
  assign io_tx = 1'h0; // @[\\src\\main\\scala\\FSM.scala 72:9]
  assign extender_clock = clock;
  assign extender_reset = reset;
  assign extender_io_Ringalarm = stateReg == 3'h3; // @[\\src\\main\\scala\\FSM.scala 60:38]
  assign extender_io_releasing = stateReg == 3'h4; // @[\\src\\main\\scala\\FSM.scala 61:38]
  assign DisplayMultiplexer_clock = clock;
  assign DisplayMultiplexer_reset = reset;
  assign DisplayMultiplexer_io_sum = {{1'd0}, Datapath_io_money}; // @[\\src\\main\\scala\\FSM.scala 64:29]
  assign DisplayMultiplexer_io_price = io_price; // @[\\src\\main\\scala\\FSM.scala 65:31]
  assign DisplayMultiplexer_io_full = stateReg == 3'h5; // @[\\src\\main\\scala\\FSM.scala 63:43]
  assign Datapath_clock = clock;
  assign Datapath_reset = reset;
  assign Datapath_io_price = io_price; // @[\\src\\main\\scala\\FSM.scala 66:21]
  assign Datapath_io_FSMstate = stateReg; // @[\\src\\main\\scala\\FSM.scala 62:36]
  always @(posedge clock) begin
    if (reset) begin // @[\\src\\main\\scala\\FSM.scala 23:25]
      stateReg <= 3'h0; // @[\\src\\main\\scala\\FSM.scala 23:25]
    end else if (3'h0 == stateReg) begin // @[\\src\\main\\scala\\FSM.scala 43:20]
      if (coin2Trigger & ~Datapath_io_Full2) begin // @[\\src\\main\\scala\\FSM.scala 45:36]
        stateReg <= 3'h1; // @[\\src\\main\\scala\\FSM.scala 46:18]
      end else if (coin5Trigger & ~Datapath_io_Full5) begin // @[\\src\\main\\scala\\FSM.scala 47:42]
        stateReg <= 3'h2; // @[\\src\\main\\scala\\FSM.scala 48:18]
      end else begin
        stateReg <= _GEN_3;
      end
    end else begin
      stateReg <= 3'h0; // @[\\src\\main\\scala\\FSM.scala 24:12]
    end
